...
public class MatrixHW {
    ...
    // Does Gauss Jordan Elimination on a matrix.
    ...
    // At the end, reports whether there is no, 1, or multiple solutions
    ...
    // Prints out solution from a final matrix, only called if know is a solution, otherwise is 
    // nonsense. Works for unique or multiple solutions
